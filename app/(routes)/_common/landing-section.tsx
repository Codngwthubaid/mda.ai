...
import { useCreateProject, useFetchProjects } from "@/features/use-project";
...
const LandingSection = () => {
  ...
  const { data: projects, isLoading, isError } = useFetchProjects(userId);
      ...
      <div className="flex flex-col">
        ...
        <div className="relative overflow-hidden pt-28">
          <div className="max-w-6xl mx-auto flex flex-col items-center justify-center">
            <div className="space-y-5 px-5 mb-8">
              <h1 className="text-center font-semibold text-4xl tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
                Design mobile apps <br className="md:hidden" />
                <span className="text-primary">in mins</span>
              </h1>
              <p className="mx-auto max-w-2xl text-center font-medium text-foreground leading-relaxed sm:text-lg md:text-xl">
                Create stunning mobile app designs effortlessly with mda.ai
              </p>
            </div>
